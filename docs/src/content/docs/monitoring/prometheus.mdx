...
| Label    | Values                                      | Description                                                                                                                                                    |
| -------- | ------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `origin` | `crowdsec`, `cscli`, `CAPI`, `lists:<name>` | Source of the decision (`lists:<name>` is the literal label for a named blocklist; the `lists:*` wildcard exists only in the `crowdsec.origins` config filter) |
