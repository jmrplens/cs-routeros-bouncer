...
description: "The cs-routeros-bouncer /health endpoint: response format, HTTP status codes, and integration examples for Docker, systemd, and Prometheus alerts."
---
