---
title: Installation
description: Install cs-routeros-bouncer with Docker Compose, as a binary with the built-in systemd installer, or by building from source — and verify it works.
---
...
1. **Download the latest release**
   ...
   # Replace architecture as needed, e.g. x86_64, i386, arm64, armv6, armv7
   ARCH=x86_64
...
# Create config directory and copy config (the archive ships it under config/)
...
See the [CLI Reference](/cs-routeros-bouncer/getting-started/cli-reference/) for all setup and uninstall flags.
