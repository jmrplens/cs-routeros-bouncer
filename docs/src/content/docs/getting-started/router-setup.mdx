...
The bouncer communicates with MikroTik via the [RouterOS API](https://help.mikrotik.com/docs/spaces/ROS/pages/47579162/API). Ensure the API service is enabled:
