...
For more details, see [Router Setup](/getting-started/router-setup/).
...
- [Full installation guide](/getting-started/installation/) — all deployment options in detail
- [Configuration reference](/configuration/) — all options explained
- [Monitoring setup](/monitoring/prometheus/) — Prometheus & Grafana
