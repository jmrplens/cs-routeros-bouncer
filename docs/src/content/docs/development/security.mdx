---
title: Security
description: "cs-routeros-bouncer security policy: supported versions, private vulnerability reporting with PGP, and hardening for credentials, Docker, and systemd."
---
...
| `ReadWritePaths=/var/log` | Allows writing logs under `/var/log` when you redirect the process output there |
