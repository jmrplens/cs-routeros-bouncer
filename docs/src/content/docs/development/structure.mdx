...
- Installs it on a RouterOS device idempotently (veth, NAT, firewall list membership), removes exactly what it created — selected by exact comment tag, plus the uploaded image — and verifies the teardown
