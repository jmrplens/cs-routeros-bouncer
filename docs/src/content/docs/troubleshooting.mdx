...
description: "Diagnose and fix common cs-routeros-bouncer problems: RouterOS and LAPI connection errors, missing firewall rules, performance issues, and Docker quirks."
---
...
3. **Verify the user's group** has required policies: `read`, `write`, `api`, `sensitive`
