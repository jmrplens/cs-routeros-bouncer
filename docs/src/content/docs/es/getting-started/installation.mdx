---
title: Instalación
description: Despliega cs-routeros-bouncer con Docker, systemd o compilándolo desde el código fuente.
---

import { Steps, Tabs, TabItem, LinkCard } from "@astrojs/starlight/components";

cs-routeros-bouncer admite varios métodos de despliegue. Elige el que mejor se adapte a tu infraestructura.
