...
3. **Despliega el bouncer**
   ...
   **Binario + systemd**
   ...
   ```bash
   # Resuelve la última versión (los archivos de la release la incluyen en el nombre)
   ...
   # Descarga (sustituye por tu arquitectura, p. ej. x86_64, i386, arm64, armv6, armv7)
   ARCH=x86_64
