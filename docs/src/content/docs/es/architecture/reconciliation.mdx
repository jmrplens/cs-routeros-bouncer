...
flowchart TB
    ...
    LIST -. "cualquier otro comentario" .-> FOREIGN["No se listan, no se comparan, no se eliminan"]
    ...
    ADDED -.-> CACHE["Caché de direcciones y métricas actualizadas"]
    REMOVED -.-> CACHE
