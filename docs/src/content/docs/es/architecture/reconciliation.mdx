...
| Comprobación periódica sin deriva     | ~1,9 s, sin escrituras de adición/eliminación                        |
| Eliminación masiva CAPI → solo local  | ~26.800 eliminaciones en ~77 s de trabajo de eliminación en RouterOS |

La cifra que se ha movido es la de la comprobación sin deriva: era de ~3–4 s
cuando se midió esta tabla, y dos cambios posteriores explican la diferencia —
la pasada de reconciliación dejó de pedir dos propiedades de la address-list que
no lee nadie (−11,2%), y un desbaneo individual dejó de recorrer la lista para
redescubrir un id que ya tenía. El valor actual sale del propio histograma
`operation_duration_seconds` del bouncer en un RB5009 de producción (RouterOS
7.24.1, 22.332 entradas IPv4 más ~525 IPv6, intervalo de 60 s): **1,86 s a lo
largo de 28 ciclos consecutivos**, un ciclo de trabajo del 3,1% frente al tiempo
real. De eso, los dos listados de address-list son el 98,5%.
