...
4. **Aplicar**
   ...
   Ejecutar las adiciones (mediante scripts masivos, 100 IPs por lote) y las eliminaciones (mediante llamadas paralelas a la API usando el pool de conexiones configurado). Cada una de las dos actualiza la caché con lo que ha intentado escribir.
