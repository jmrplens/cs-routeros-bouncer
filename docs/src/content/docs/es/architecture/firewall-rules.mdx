...
description: Cómo cs-routeros-bouncer crea, ordena y limpia las reglas filter y raw del firewall de MikroTik, y cómo identifica sus bloques de reglas gestionados.
---
