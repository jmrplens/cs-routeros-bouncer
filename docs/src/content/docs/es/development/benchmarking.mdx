...
repositorio llevó desde la 1.5.0 hasta que se eliminó: compilaba en cruzado un
...
`MIKROSCOPE_INFLUX_TOKEN` y nunca de un flag, porque un flag se ve en `ps` — y
a partir de ahí una pregunta sobre CPU es una consulta, no un despliegue:
