...
- Lo instala en un dispositivo RouterOS de forma idempotente (veth, NAT, pertenencia a listas de firewall), desinstala exactamente lo que creó — seleccionado por comentario exacto, más la imagen subida — y verifica la desinstalación
