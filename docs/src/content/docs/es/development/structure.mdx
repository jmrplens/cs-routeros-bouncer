...
description: "Estructura del repositorio de cs-routeros-bouncer: árbol de directorios y responsabilidades de cada paquete Go (config, crowdsec, manager, metrics, routeros)."
---
