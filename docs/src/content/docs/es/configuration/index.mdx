...
description: Todas las opciones de configuración de cs-routeros-bouncer de un vistazo.
...
Opciones de ajuste fino para el filtrado de decisiones, TLS, rendimiento, personalización del firewall y observabilidad. Los valores por defecto funcionan bien en la mayoría de las instalaciones.
