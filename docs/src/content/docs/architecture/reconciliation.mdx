...
4. **Apply**
   ...
   Execute additions (via bulk scripts, 100 IPs/batch) and deletions (via parallel API calls using the configured connection pool). Each of the two patches the cache with what it attempted to write.
