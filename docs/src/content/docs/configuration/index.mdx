...
<CardGrid>
  <LinkCard title="CrowdSec" description="LAPI connection, polling, decision filtering." href="/cs-routeros-bouncer/configuration/crowdsec/" />
  <LinkCard title="MikroTik" description="RouterOS API connection, TLS, and timeouts." href="/cs-routeros-bouncer/configuration/mikrotik/" />
  <LinkCard title="Firewall" description="IPv4/IPv6, filter/raw rules, output blocking, logging." href="/cs-routeros-bouncer/configuration/firewall/" />
  <LinkCard title="Logging & Metrics" description="Log level/format, Prometheus metrics endpoint." href="/cs-routeros-bouncer/configuration/logging-metrics/" />
  <LinkCard title="Examples" description="Complete configuration examples for common scenarios." href="/cs-routeros-bouncer/configuration/examples/" />
</CardGrid>
