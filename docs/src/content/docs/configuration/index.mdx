...
| `firewall.rule_placement.position`          | `FIREWALL_RULE_PLACEMENT_POSITION`          |                    | Zero-based RouterOS `print` position                                                                                                                                                                                                      |
| `firewall.rule_placement.fallback`          | `FIREWALL_RULE_PLACEMENT_FALLBACK`          | `top`              | Fallback for comment placement: `top` or `bottom`                                                                                                                                                                                         |
| `firewall.rule_placement.filter`            | YAML only                                   |                    | Filter-table override; inherits unspecified global fields                                                                                                                                                                                 |
| `firewall.rule_placement.raw`               | YAML only                                   |                    | Raw-table override; inherits unspecified global fields                                                                                                                                                                                    |
| `firewall.ipv4.rule_placement`              | YAML only                                   |                    | IPv4-only placement override; inherits unspecified global fields                                                                                                                                                                          |
| `firewall.ipv6.rule_placement`              | YAML only                                   |                    | IPv6-only placement override; inherits unspecified global fields                                                                                                                                                                          |
