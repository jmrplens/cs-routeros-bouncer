...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_IPV4_ENABLED` · **Default:** `true`
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_IPV4_ADDRESS_LIST` · **Default:** `crowdsec-banned`
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_IPV6_ENABLED` · **Default:** `true`
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_IPV6_ADDRESS_LIST` · **Default:** `crowdsec6-banned`
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_FILTER_ENABLED` · **Default:** `true`
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_FILTER_CHAINS` · **Default:** `["input"]`
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_RAW_ENABLED` · **Default:** `true`
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_RAW_CHAINS` · **Default:** `["prerouting"]`
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_DENY_ACTION` · **Default:** `drop`
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_RULE_PLACEMENT` · **Default:** `top`
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_COMMENT_PREFIX` · **Default:** `crowdsec-bouncer`
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_LOG` · **Default:** `false`

Enable RouterOS logging on firewall rules. When enabled, matched packets are logged in the RouterOS system log.

### `firewall.log_prefix`

<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_LOG_PREFIX` · **Default:** `crowdsec-bouncer`
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_INPUT_INTERFACE` · **Default:** — (all interfaces)
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_INPUT_INTERFACE_LIST` · **Default:** — (all interfaces)
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_BLOCK_OUTPUT` · **Default:** `false`
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_OUTPUT_INTERFACE` · **Default:** —
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_OUTPUT_INTERFACE_LIST` · **Default:** —
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_REJECT_WITH` · **Default:** —
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_FILTER_CONNECTION_STATE` · **Default:** — (matches all)
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_FILTER_LOG_PREFIX` / `FIREWALL_RAW_LOG_PREFIX` / `FIREWALL_OUTPUT_LOG_PREFIX`
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_INPUT_WHITELIST` · **Default:** —
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_OUTPUT_PASSTHROUGH_V4` / `FIREWALL_OUTPUT_PASSTHROUGH_V6` · **Default:** —
...
<Badge text="Optional" variant="note" /> **Env:** `FIREWALL_OUTPUT_PASSTHROUGH_V4_LIST` / `FIREWALL_OUTPUT_PASSTHROUGH_V6_LIST` · **Default:** —
