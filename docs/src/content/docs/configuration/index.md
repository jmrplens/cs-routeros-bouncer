...
| Section | Description |
|---------|-------------|
| [CrowdSec](/configuration/crowdsec/) | LAPI connection, polling, decision filtering |
| [MikroTik](/configuration/mikrotik/) | RouterOS API connection and timeouts |
| [Firewall](/configuration/firewall/) | IPv4/IPv6, filter/raw rules, output blocking, logging |
| [Logging & Metrics](/configuration/logging-metrics/) | Log level/format, Prometheus metrics |
| [Examples](/configuration/examples/) | Complete configuration examples for common scenarios |
...
#### [CrowdSec](/configuration/crowdsec/) — polling, filtering & TLS
...
#### [MikroTik](/configuration/mikrotik/) — TLS & performance
...
#### [Firewall](/configuration/firewall/) — rules, interfaces & logging
...
#### [Logging & Metrics](/configuration/logging-metrics/) — format, file output & Prometheus
