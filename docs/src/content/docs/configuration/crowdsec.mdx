...
Leaving `origins` empty accepts all origins, including `CAPI` and `lists:*`. See [CAPI Blocklists](/cs-routeros-bouncer/configuration/capi-blocklists/) for scale and router sizing guidance.
