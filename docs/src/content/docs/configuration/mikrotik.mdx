...
The RouterOS API username. Use a dedicated user with minimal permissions. See [Router Setup](/cs-routeros-bouncer/getting-started/router-setup/) for creating the user.
