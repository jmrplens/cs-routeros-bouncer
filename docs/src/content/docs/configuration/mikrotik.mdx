...
<Badge text="Required" variant="danger" /> **Env:** `MIKROTIK_HOST` · **Default:** `192.168.0.1:8728`
...
<Badge text="Required" variant="danger" /> **Env:** `MIKROTIK_USER` · **Default:** `crowdsec`
...
<Badge text="Required" variant="danger" /> **Env:** `MIKROTIK_PASS` · **Default:** —
...
<Badge text="Optional" variant="note" /> **Env:** `MIKROTIK_TLS` · **Default:** `false`
...
<Badge text="Optional" variant="note" /> **Env:** `MIKROTIK_TLS_INSECURE` · **Default:** `false`
...
<Badge text="Optional" variant="note" /> **Env:** `MIKROTIK_CONN_TIMEOUT` · **Default:** `10s`

Maximum time to wait for the initial API connection. Uses Go duration format.

### `mikrotik.command_timeout`

<Badge text="Optional" variant="note" /> **Env:** `MIKROTIK_CMD_TIMEOUT` · **Default:** `30s`
...
<Badge text="Optional" variant="note" /> **Env:** `MIKROTIK_POOL_SIZE` · **Default:** `4`
