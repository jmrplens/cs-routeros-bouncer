...
// rhysd/actionlint uses the go.yaml.in/yaml/v4 rc.3 API, which changed in rc.4.
// Newer releases of other tools (securego/gosec) carry an rc.6 *indirect*
// requirement they do not actually use (gosec's own code is on yaml/v3), and
// MVS would otherwise select it and break the actionlint build.
// Drop this once actionlint moves past rc.3.
