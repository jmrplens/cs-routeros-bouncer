...
func normalizeRouterOSCommandValues(firewall *FirewallConfig) {
	...
	firewall.Filter.LogPrefix = strings.TrimSpace(firewall.Filter.LogPrefix)
	firewall.Raw.Chains = trimStringSlice(firewall.Raw.Chains)
	firewall.Raw.LogPrefix = strings.TrimSpace(firewall.Raw.LogPrefix)
	firewall.DenyAction = strings.TrimSpace(firewall.DenyAction)
	firewall.RejectWith = strings.TrimSpace(firewall.RejectWith)
	firewall.LogPrefix = strings.TrimSpace(firewall.LogPrefix)
	...
	firewall.BlockOutput.LogPrefix = strings.TrimSpace(firewall.BlockOutput.LogPrefix)
