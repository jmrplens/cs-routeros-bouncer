...
//
// On shutdown, [Manager.Shutdown] removes firewall rules. Address list entries
// are left to expire via their MikroTik timeout, ensuring no traffic is allowed
// prematurely.
package manager
